...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var messageOne = a + ' and ' + b + ' and ' + c + ' sum to ' + sum1 + '.';
  var messageTwo = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product + '.';
  return [sum1, product, messageOne, messageTwo];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var message = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' +  multArr[2] + ' have a product of ' + product + '.';
  return [product, message];
}
...
function multiplyAnyArray(dynamicArray) { 
  ...
  for (var j = 0; j < dynamicArray.length; j++) {
    if (j < (dynamicArray.length - 1)) {
      arrayElements += dynamicArray[j] + ',';
    }
    else {
      arrayElements += dynamicArray[j];
    }
  }
  var message = 'The numbers ' + arrayElements + ' have a product of ' + product + '.';
  return [product, message];
}
